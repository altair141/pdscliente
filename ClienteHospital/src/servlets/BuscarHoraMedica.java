...
/**
 * Servlet implementation class BuscarHoraMedica
 */
@WebServlet(name = "BuscarHoraMedica", urlPatterns = { "/BuscarHoraMedica" })
public class BuscarHoraMedica extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public BuscarHoraMedica() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		getServletContext().getRequestDispatcher("/listaHoraMedica.jsp")
